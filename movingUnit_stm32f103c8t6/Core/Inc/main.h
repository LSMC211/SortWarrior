...
#define M1ENCA_Pin GPIO_PIN_6
#define M1ENCA_GPIO_Port GPIOA
#define M1ENCB_Pin GPIO_PIN_7
#define M1ENCB_GPIO_Port GPIOA
#define M1A_Pin GPIO_PIN_12
#define M1A_GPIO_Port GPIOB
#define M1B_Pin GPIO_PIN_13
#define M1B_GPIO_Port GPIOB
#define M2A_Pin GPIO_PIN_14
#define M2A_GPIO_Port GPIOB
#define M2B_Pin GPIO_PIN_15
#define M2B_GPIO_Port GPIOB
#define M2ENCA_Pin GPIO_PIN_6
#define M2ENCA_GPIO_Port GPIOB
#define M2ENCB_Pin GPIO_PIN_7
#define M2ENCB_GPIO_Port GPIOB
